...
def performPlacement(inputFile, outputFile):
	...
	## This does a a)iperf b) iperf6, b)fdt6, c) scp6, d) netcat6, e) iperf6 
  	## sequence of tests.  remove any of the (,,) to remove a test 
	movers = [ ("iperf6", IperfMover.Iperf6(), ChirpTools.ChirpInfo("iperf6")), 
				("fdt6", FDTMover.FDTMover6(), ChirpTools.ChirpInfo("fdt6")),
				("scp6", SCPMover.SCPMover6(), ChirpTools.ChirpInfo("scp6")),
				("netcat6", NetcatMover.Netcat6(), ChirpTools.ChirpInfo("netcat6")),
				("iperf6", IperfMover.Iperf6(), ChirpTools.ChirpInfo("iperf6")) ] 
